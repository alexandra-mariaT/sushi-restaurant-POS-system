🍣 Sushi Garden POS is a user-friendly management system for a Sushi restaurant, built with Java. It helps waiters take orders and allows managers to track daily sales.
